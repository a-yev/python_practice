# Write a Pandas program to select the rows the score is between 4 and 8 (inclusive).
...
print(("Rows where score between 4 and 8 (inclusive):") + str(df[df['score'].between(4, 8)]))
